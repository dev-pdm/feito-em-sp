...
let crono = setInterval(function() {
    ...
    if (distance < 0) {
    clearInterval(crono);
    document.getElementById("cronometro").innerHTML = "Inscrições encerrada para sua Macrorregião";
    }
}, 1000);
...
let crono2 = setInterval(function() {
    ...
    document.getElementById("cronometro2").innerHTML = "Inscrições encerrada para sua Macrorregião";
    }
}, 1000);

// Cronometro Franca
let dataFinal3 = new Date("Sep 25, 2019 23:59:00").getTime();
...
let crono3 = setInterval(function() {
    ...
    document.getElementById("cronometro3").innerHTML = "Inscrições encerrada para sua Macrorregião";
    }
}, 1000);

// Cronometro Barretos
let dataFinal4 = new Date("Sep 29, 2019 23:59:00").getTime();
...
let crono4 = setInterval(function() {
    ...
    document.getElementById("cronometro4").innerHTML = "Inscrições encerrada para sua Macrorregião";
    }
}, 1000);
...
let crono5 = setInterval(function() {
    ...
    document.getElementById("cronometro5").innerHTML = "Inscrições encerrada para sua Macrorregião";
    }
}, 1000);

// Cronometro Araçatuba
let dataFinal6 = new Date("Sep 29, 2019 23:59:00").getTime();
...
let crono6 = setInterval(function() {
    ...
    document.getElementById("cronometro6").innerHTML = "Inscrições encerrada para sua Macrorregião";
    }
}, 1000);

// Cronometro Presidente Prudente
let dataFinal7 = new Date("Sep 29, 2019 23:59:00").getTime();
...
let crono7 = setInterval(function() {
    ...
    document.getElementById("cronometro7").innerHTML = "Inscrições encerrada para sua Macrorregião";
    }
}, 1000);

// Cronometro Marília
let dataFinal8 = new Date("Sep 29, 2019 23:59:00").getTime();
...
let crono8 = setInterval(function() {
    ...
    document.getElementById("cronometro8").innerHTML = "Inscrições encerrada para sua Macrorregião";
    }
}, 1000);

// Cronometro Bauru
let dataFinal9 = new Date("Sep 29, 2019 23:59:00").getTime();
...
let crono9 = setInterval(function() {
    ...
    document.getElementById("cronometro9").innerHTML = "Inscrições encerrada para sua Macrorregião";
    }
}, 1000);

// Cronometro Sorocaba
let dataFinal10 = new Date("Sep 29, 2019 23:59:00").getTime();
...
let crono10 = setInterval(function() {
    ...
    document.getElementById("cronometro10").innerHTML = "Inscrições encerrada para sua Macrorregião";
    }
}, 1000);

// Cronometro Campinas
let dataFinal11 = new Date("Sep 29, 2019 23:59:00").getTime();
...
let crono11 = setInterval(function() {
    ...
    document.getElementById("cronometro11").innerHTML = "Inscrições encerrada para sua Macrorregião";
    }
}, 1000);

// Cronometro Taubaté
let dataFinal12 = new Date("Sep 29, 2019 23:59:00").getTime();
...
let crono12 = setInterval(function() {
    ...
    document.getElementById("cronometro12").innerHTML = "Inscrições encerrada para sua Macrorregião";
    }
}, 1000);

// Cronometro Santos
let dataFinal13 = new Date("Oct 03, 2019 23:59:00").getTime();
...
let crono13 = setInterval(function() {
    ...
    document.getElementById("cronometro13").innerHTML = "Inscrições encerrada para sua Macrorregião";
    }
}, 1000);

// Cronometro Registro
let dataFinal14 = new Date("Oct 03, 2019 23:59:00").getTime();
...
let crono14 = setInterval(function() {
    ...
    document.getElementById("cronometro14").innerHTML = "Inscrições encerrada para sua Macrorregião";
    }
}, 1000);

// Cronometro São Bernardo
let dataFinal15 = new Date("Oct 03, 2019 23:59:00").getTime();
...
let crono15 = setInterval(function() {
    ...
    document.getElementById("cronometro15").innerHTML = "Inscrições encerrada para sua Macrorregião";
    }
}, 1000);
